...
const homepageSchema = () => [
  ...
  },
  {
    ...
    description:
      "Discover deals, events, news, and local businesses in Jaipur. Your trusted local platform for everything Pink City.",
...
// ──────────────────
// 🔵 NEWS ARTICLE SCHEMA (UPDATED with author and image)
// ──────────────────
const newsSchema = (data: SchemaData) => [
  {
    "@context": "https://schema.org",
    "@type": data.articleType === "news_flash" ? "NewsArticle" : "Article",
    headline: data.title,
    ...
    image: {
      "@type": "ImageObject",
      url: data.image || DEFAULT_IMAGE,
    },
    author: {
      "@type": "Person",
      name: data.author || "JaipurCircle Team",
      url: `${SITE_URL}/authors/jaipurcircle-team`,
    },
    publisher: {
      "@type": "Organization",
      name: SITE_NAME,
...
// ──────────────────
// 🔵 EVENT SCHEMA (UPDATED with performer, organizer, and complete fields)
// ──────────────────
const eventSchema = (data: SchemaData) => [
  {
    ...
    location: {
      "@type": "Place",
      name: data.venue || "Sawai Mansingh Stadium",
      address: {
        "@type": "PostalAddress",
        streetAddress: data.address || "Tonk Road",
        addressLocality: "Jaipur",
        addressRegion: "Rajasthan",
        postalCode: "302015",
        addressCountry: "IN",
    ...
    organizer: {
      "@type": "Organization",
      name: data.organizer || "Rajasthan Royals",
      url: "https://www.rajasthanroyals.com",
    },
    performer: {
      "@type": "SportsTeam",
      name: data.performer || "Rajasthan Royals",
      sport: "Cricket",
    },
    url: data.url,
    ...(data.ticketUrl && {
...
// ──────────────────
// 🔵 GUIDE / ARTICLE SCHEMA (UPDATED with author and image)
// ──────────────────
