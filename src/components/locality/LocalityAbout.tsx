...
export function LocalityAbout({ locality }: LocalityAboutProps) {
  ...
  /**
   * 🟣 AUTHORITY CONTENT — Vaishali Nagar (manual, curated, SEO-rich)
   * Only renders for this locality. Other localities continue using generic narrative.
   */
  ...
  /**
   * 🟢 Default structured narrative (auto-generated)
   */
  ...
  /**
   * 🟣 Final content block rendered:
   * If Vaishali Nagar → authority content + generic content
   * Otherwise → generic content only
   */
