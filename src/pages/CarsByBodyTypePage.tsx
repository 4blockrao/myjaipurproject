...
import { Car, ArrowLeft, Truck, CarFront } from 'lucide-react';
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground capitalize mt-1">
                            {car.fuel_type} • {car.transmission} • {car.seating_capacity} Seater
                          </p>
                        </div>
                        {car.brand?.logo_url && (
                      ...
                      <div className="mt-3 pt-3 border-t flex items-end justify-between">
                        ...
                        {car.mileage_city && (
                          <div className="text-right">
                            <p className="text-sm font-medium text-foreground">{car.mileage_city} kmpl</p>
