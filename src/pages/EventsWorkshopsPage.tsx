...
const EventsWorkshopsPage = () => {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Workshops", "item": `${SITE_URL}/events/workshops` }
    ]
  };
  ...
  return (
    <AppLayout
      ...
      seoTitle="Workshops in Jaipur 2025 | Classes, Training & Learning Events"
      seoDescription="Find workshops in Jaipur - photography, art & craft, cooking, music, coding, pottery and more. Hands-on learning experiences across Jaipur localities."
