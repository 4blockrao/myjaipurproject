...
const EventsFreeFilterPage = () => {
  ...
  const collectionSchema = {
    ...
    "url": "https://www.jaipurcircle.com/events/free",
    "areaServed": {
      "@type": "City",
      "name": "Jaipur",
      "containedInPlace": {
  ...
  return (
    <>
      <Helmet>
        <title>Free Events in Jaipur 2025 | Concerts, Workshops & Activities | JaipurCircle</title>
        <meta name="description" content="Discover free events in Jaipur - concerts, workshops, cultural festivals, exhibitions and community activities. Find free things to do across Jaipur localities." />
        ...
        <link rel="canonical" href="https://www.jaipurcircle.com/events/free" />
        <meta property="og:title" content="Free Events & Activities in Jaipur" />
        <meta property="og:description" content="Explore free concerts, workshops, cultural events and community activities happening across Jaipur." />
        <meta property="og:url" content="https://www.jaipurcircle.com/events/free" />
        ...
        <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-lg border-b border-border">
          <div className="flex items-center justify-between px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">Free Events</h1>
                <p className="text-xs text-muted-foreground">No tickets required</p>
              </div>
            </div>
