...
const EventsLocalityPage = () => {
  ...
  return (
    <AppLayout
      ...
      seoTitle={`Events in ${localityName}, Jaipur 2025 | Things To Do`}
      seoDescription={`Find events in ${localityName}, Jaipur - concerts, workshops, exhibitions and activities. Discover things to do in ${localityName} area.`}
