...
const modelsData = [
  ...
  { brand_slug: 'maruti-suzuki', name: 'Victoris', slug: 'victoris', body_type: 'SUV', fuel_type: 'Petrol', transmission: 'Manual', ex_showroom_price_min: 1050000, ex_showroom_price_max: 1700000, on_road_price_jaipur_min: 1220000, on_road_price_jaipur_max: 1950000, mileage_city: 14, mileage_highway: 18, engine_cc: 1462, power_bhp: 105, torque_nm: 137, seating_capacity: 7, is_trending: true, is_new_launch: true, cover_image: 'https://imgd.aeplcdn.com/664x374/n/cw/ec/181991/victoris-exterior-right-front-three-quarter-3.png', pros: ['New launch', '7 seater', 'Premium SUV', 'Maruti reliability'], cons: ['Only petrol', 'Higher price'], best_for: ['Premium family buyers', 'Upgraders'] },
