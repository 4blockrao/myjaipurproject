...
export default async function handler(req, res) {
  ...
  // Extract locality and cluster from path like /jaipur/vaishali-nagar/restaurants
  const match = fullUrl.match(/\/jaipur\/([^\/]+)\/([^\/]+)/);
  ...
  // Forward to Edge Function with the same path structure
